...
// // for (int i = 1, j=5, k=10; i < 5 && j<10 && k<15; i++, j+=2, k+=3) // для примера взяла, чтоб усвоить материал 
...
// int x = 5;
// // $ - ставится в начале строки перед двойными кавычками. 
// // Говорит о том, что в эту строку можно вставить переменную
// // внутри строки (между двойными кавычками) указываются 
